...
def homepage():
    st.markdown(
        """
        <h1 style="font-family: 'Arial', cursive; color:#F2D2BD ; font-size: 65px; text-align: center;">
        Cardiovascular Risk Prediction🫀
        </h1>
        <p style="font-family: 'CabinSketch Bold', cursive; color:Light Pink ; font-size: 20px; text-align: center;">
        <i>"The greatest wealth is health"</i>
         <p style="font-family: 'Arial', cursive; color:Light Pink; font-size: 10px; text-align: center;">
