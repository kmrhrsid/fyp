...
background_image_url = "https://img.freepik.com/free-vector/abstract-gradient-background_23-2149238572.jpg"  # Use the direct image URL

# Apply background image via custom CSS
st.markdown(
    f"""
    <style>
