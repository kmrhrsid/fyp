...
def homepage():
    st.markdown(
        ...
        <p style="font-family: 'CabinSketch Bold', cursive; #dfdfc6  ; font-size: 40px; text-align: center;">
        <i>"The greatest wealth is health"</i>
         <p style="font-family: 'Arial', cursive; color:#dfdfc6 ; font-size: 15px; text-align: center;">
